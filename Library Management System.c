...
struct student *book_list(struct student *start);
...
void password()
{
    ...
    if(strcmp(realpassword,user_password) ==0)
    {
        printf("\n\tMatch Password\n");
        printf("\n\t    Press any key......\n");
    }
...
struct book *initialize_lib(struct book *start){
    ...
    new_book1->next=NULL;
    start_lib=new_book1;
    strcpy(new_book1->name,"Agni Bina");
    strcpy(new_book1->author,"Kazi Nazrul Islam");
    new_book1->id=125;
    ptr=new_book1;

    new_book2=(struct book*)malloc(sizeof(struct book));
    new_book2->next=NULL;
    strcpy(new_book2->name,"Gitanjali");
    strcpy(new_book2->author,"Rabindranath Tagore");
    new_book2->id=132;
    ptr->next=new_book2;
    ptr=new_book2;
    ...
    new_book3->next=NULL;
    strcpy(new_book3->name,"Rakhali");
    strcpy(new_book3->author,"Jashim Uddin");
    new_book3->id=113;
    ptr->next=new_book3;
    ptr=new_book3;
    ...
    new_book4->next=NULL;
    strcpy(new_book4->name,"Deowal");
    strcpy(new_book4->author,"Humayun Ahmed");
    new_book4->id=157;
    ptr->next=new_book4;
    ptr=new_book4;
    ...
    new_book5->next=NULL;
    strcpy(new_book5->name,"Shajher Maya");
    strcpy(new_book5->author,"Sufia K145amal");
    new_book5->id=145;
    ptr->next=new_book5;
